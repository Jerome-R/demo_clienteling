...
class CSVController extends Controller
{
    ...
    public function importFileAction(Request $request) {
        ...
        {
            //$file = fopen('D:\wamp\www\StoreApp\web\imports\ciblage_ad_hoc_PRCaen_clienteling_20160908.csv', "r");
            $file = fopen('D:\wamp\www\StoreApp\web\imports\ciblage_ad_hoc_'.$csv.'.csv', "r");
        }
        else{
            
            //$file = fopen('/data/ftp/imports/ciblage_ad_hoc_PRCaen_clienteling_20160908.csv', "r");
            $file = fopen('/data/ftp/imports/ciblage_ad_hoc_'.$csv.'.csv', "r");
        }*/
