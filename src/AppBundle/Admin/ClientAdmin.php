        ...
        $formMapper
            ->tab("General informations")
                ->with("Client infos")
                    ...
                    ->add('telephone3', 'text', array('required' => false))
                    ->add('portable1', 'text', array('required' => false))
                    ->add('portable2', 'text', array('required' => false))
                    ->add('portable3', 'text', array('required' => false))
