...
strVar_AA_FR += "&nbsp;<br \/>";
strVar_AA_FR += "Nous serions ravis de vous accueillir à nouveau. Nous pourrions à cette occasion réaliser gracieusement, <strong>un contrôle d'étanchéité<\/strong>*.<br\/>";
strVar_AA_FR += "&nbsp;<br \/>";
